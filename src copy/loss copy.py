...
def normal_coss_loss(pred, feed_dict, block_id, idx2, gt):
    ...
    gt_nm = tf.reshape(gt_nm, [gt_shape[0]*gt_shape_1, gt_shape[-1]])
    ...
    indices = tf.compat.v1.Print(indices, [gt_nm, gt_shape2, gt_shape, tf.shape(indices), indices], message="Normal Coss ")
